...
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/data-index/css_test/toppage.css">
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/data-common/css/common_form.css">
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/data-index/css_test/jquery.bxslider.css">
...
<script src="<?php bloginfo('template_directory'); ?>/data-common/js/jquery.rwdImageMaps.min.js"></script>
...
<script src="<?php bloginfo('template_directory'); ?>/data-common/js/import_script_pc_TEST.js"></script>
<!--スクリプトここまで-->
...
<script>
   ...
   <!--トップースライダー(flexslider)ここから-->
        <ul class="bxslider">
          ...
          <?php $pic= get_sub_field('test_slide');?>
          ...
          <li><?php echo $pic['url'] ;?>
            ...
            <a href="<?php echo $links ;?>">
              ...
              <?php echo wp_get_attachment_image( $pic, 'full' );?>
            </a>
            <?php else :?>
              <!--<img src="<?php echo $pic ;?>" alt="" width="" height="">-->
              <?php echo wp_get_attachment_image( $pic, 'full' );?>
        ...
        <section>
          ...
          <div class="content_outline">
            ...
            <div id="project">
              ...
              <div class="column_3">
                <?php $the_query = new WP_Query( array('posts_per_page' => 4, 'post_type' => 'page', 'orderby' =>'date', 'post_parent' => 504)); ?>
            ...
            <div id="shop_list">
              ...
              <div class="column_3 fixHeight">
                ...
                <?php $the_query = new WP_Query( array('posts_per_page' => 6, 'post_type' => 'shop', 'orderby' =>'date')); ?>
                <?php if ( $the_query->have_posts() ) :  while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                <?php $pageslug = $post->post_name; ?>
                <?php $postoid = $post->ID ;?>
                <div class="box">
