...
$thanksPage = "http://hontoyutari.com/contact/order_thx.html";
...
$eles = array('お名前：姓','お名前：名','郵便番号','ご住所','お電話','Email');
...
$re_subject = "ご注文ありがとうございました[本とゆたり]";
...
ご注文ありがとうございました。
振込先・合計金額の確認等近日中にご返信致しますので今しばらくお待ちください。
...
if($esse == 1) {
	...
	foreach($_POST as $key=>$val) {
		if($val != "confirm_submit"){
			/*if(($key=="品名A"&&$val=='')&&($key=="数量A"&&$val=='')&&($key=="品名B"&&$val=='')&&($key=="数量B"&&$val=='')&&($key=="品名C"&&$val=='')&&($key=="数量C"&&$val==''))$flg_goods="false";*/
			if($flg_goods=="false"){
				$errm = "<p class=\"error_messe\">「商品名」は必須入力項目です。</p>\n";
				$empty_flag = 1;
			}
...
/**/
$daty = date( "Y/m/d (D) H:i:s", time() );
$ordernum .= date("His",time());
foreach($_POST as $key=>$val) {
	if($key=="お電話"){
		$phonenum = mb_substr($val,-4,4);
		$ordernum .= $phonenum;
	}
}
/**/
$post = array("オーダー番号"=>$ordernum);
...
<link rel="stylesheet" href="../css/page/contact/contact_common.css">
<link rel="stylesheet" href="../css/page/contact/contact.css">
<script src="../js/import_js_pc.js"></script>
<script src="../js/import_script_pc.js"></script>
</head>
...
<div id="page_ttl">
<img src="../image/contact/common/img-page_header_contact.png" width="1300" height="195" alt="CONTACT">
</div>
...
foreach($_POST as $key=>$val) {
	...
	if($key!=="submit"){
		if($key=="備考"){
			echo "<div class=\"ttl\">".$key."</div><textarea id=\"備考\" readonly>".$out."</textarea>";
		}elseif($key=="オーダー番号"){
			echo "";
		}elseif(preg_match("/".$goodsname."[A-Z]/",$key,$s0)){
			$goodslett = mb_substr($s0[0],-1,1);
			$goodskey = $goodsnum.$goodslett;
			$out2 = $out;
		}elseif(preg_match("/".$goodskey."/",$key)){
			if($out2 && $out){
				echo "<div class=\"ttl\">".$goodslett."</div><input type=\"text\" id=\"{$out}\" value=\"".$out2."\" readonly>";
				echo "<div class=\"ttl\">".$key."</div><input type=\"text\" id=\"{$goodskey}\" value=\"".$out."\" readonly>";
			}
			//$out2 = "";
		}elseif($out==""){
				echo "";
		}else{
			echo "<div class=\"ttl\">".$key."</div><input type=\"text\" id=\"{$key}\" value=\"".$out."\" readonly>";
		}
	}
	/**/
...
?>
<?php
	if($out) echo "<input type=\"hidden\" name=\"".$key."\" value=\"".$out."\">";
?>
<?php
	echo "</td></tr>\n";
}
...
<li><a href="shop_law.html">特定商取引法に基づく表記</a></li>
</ul>
</div>
...
<div id="page_top">
<a href="#wrapper"><img src="../image/common/contents/btn-page_top.png" width="57" height="57" alt="PAGE TOP"></a>
</div>
...
<table>
<tr>
<td><a href="../book/index.html"><img src="../image/common/footer/nav-book_off.png" width="48" height="26" alt="BOOK"></a></td>
<td><a href="../goods/index.html"><img src="../image/common/footer/nav-goods_off.png" width="59" height="26" alt="GOODS"></a></td>
<td><a href="../project/index.html"><img src="../image/common/footer/nav-project_off.png" width="78" height="26" alt="PROJECT"></a></td>
<td><a href="../shop/index.html"><img src="../image/common/footer/nav-shop_list_off.png" width="96" height="26" alt="SHOP LIST"></a></td>
<td><a href="../about/about.html"><img src="../image/common/footer/nav-about_us_off.png" width="91" height="26" alt="ABOUT US"></a></td>
<td><a href="../info/info.html"><img src="../image/common/footer/nav-information_off.png" width="122" height="26" alt="INFORMATION"></a></td>
<td><a href="../contact/contact.html"><img src="../image/common/footer/nav-contact_off.png" width="81" height="26" alt="CONTACT"></a></td>
</tr>
</table>
</div>
</footer>
...
<div id="site_logo">
<a href="../"><img src="../image/common/sidebar/logo.png" width="152" height="282" alt="本とゆたり　BOOK AND YUTARI"></a>
</div>

<!--グローバルナビここから-->
<ul id="g_nav">
<li><a href="../book/index.html"><img src="../image/common/sidebar/nav-book_off.png" width="114" height="26" alt="BOOK"></a></li>
<li><a href="../goods/index.html"><img src="../image/common/sidebar/nav-goods_off.png" width="114" height="26" alt="GOODS"></a></li>
<li><a href="../project/index.html"><img src="../image/common/sidebar/nav-project_off.png" width="114" height="26" alt="PROJECT"></a></li>
<li><a href="../shop/index.html"><img src="../image/common/sidebar/nav-shop_list_off.png" width="114" height="26" alt="SHOP LIST"></a></li>
<li><a href="https://hontoyutari.stores.jp/" target="_blank"><img src="../image/common/sidebar/btn-online_store_off.png" width="168" height="51" alt="ONLINE STORE"></a></li>
<li><a href="../about/about.html"><img src="../image/common/sidebar/nav-about_us_off.png" width="114" height="26" alt="ABOUT US"></a></li>
</ul>
<!--グローバルナビここまで-->
...
<!--アイコン各種ここから-->
<div id="yutari_icon">
<a href="#"><img src="../image/common/sidebar/icon-yutari.png" width="38" height="38" alt="本とゆたり　BOOK AND YUTARI"></a>
</div>

<!--アイコン各種ここまで-->

Copyright(c) Hon to yutari<br>
All Rights Reserved.
</div>
<!--サイドバーコンテンツここまで-->
