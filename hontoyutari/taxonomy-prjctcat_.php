...
<div id="wrapper">
  ...
  <div id="container">
   ...
   <!--ヘッダー帯画像-->
    <div id="page_ttl">
      <img src="<?php bloginfo('template_directory'); ?>/data-project/image/img-page_header_project.png" width="1300" height="195" alt="PROJECT">
    </div>
    <!--ヘッダー帯画像-->
        ...
        <section>
          ...
          <div class="content_outline">
            <div class="contents">
              ...
              ?>
              <?php if (have_posts()):?><?php $x=1; while (have_posts()) : the_post(); $loopcounter++;?>
              <div id="project_contents">
                <table>
                  <tr>
                    ...
                    <td>
                      <p class="num"><?php echo $catinfo->name;?>&nbsp;&nbsp;
